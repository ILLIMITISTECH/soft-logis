                    ...
                    <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
                        ...
                        <div class="col">
                            <div class="p-3">
                                ...
                                <h6 class="mb-0 {{ Carbon\Carbon::parse($firstNextArrivage->date_arriver)->isPast() ? 'text-danger' : '' }}">
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.sourcing.show', $item->uuid) }}" class=" text-decoration-none {{ Carbon\Carbon::parse($item->date_arriver)->isPast() ? 'text-danger' : '' }}">
