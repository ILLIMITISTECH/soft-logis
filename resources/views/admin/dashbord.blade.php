                    ...
                    <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
                        ...
                        <div class="col">
                            <div class="p-3">
                                ...
                                <p> <i class="bx bx-up-arrow-alt align-middle"></i> {{ number_format($stockPreviewValue), 0, ',', ' ' }} <span>Fcfa</span></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3">
                                ...
                                @endif
                                <small class="mb-0">
                                    <button type="button" class=" btn btn-sm bg-transparent" data-bs-toggle="modal" data-bs-target="#nextArrivageModal">Lister <i class="bx bx-right-arrow-alt align-middle text-success"></i></button>
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card radius-10 w-100">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown ms-auto my-auto py-auto" id="idRotationData">
                                    <button class="btn btn-outline-success px-2 size_12 border-0 active focus-outline-none" id="btnRotationStockIn" onclick="rotationDisplayIn('idRotationStockIn')"><i class="lni lni-arrow-down size_12"></i> In</button>
                                    <button class=" btn btn-outline-danger px-2 size_12 border-0" id="btnRotationStockOut" onclick="rotationDisplayOut('idRotationStockOut')"><i class="lni lni-arrow-up size_12"></i>Out</button>
                    ...
                    <div class="card-body pb-0" id="idRotationStockIn">
                        <div class="button-container row col-12 d-flex justify-content-between mx-1" style="height: 5%">
                            <button class="rounded-button active col-6 mx-0" id="idMensuel" onclick="toggleDisplay('idMensuelBlock')">Mensuel</button>
                            <button class="rounded-button col-6 mx-0" id="idHebdomadaire" onclick="toggleDispla('idHebdomadaireBlock')">Hebdomadaire</button>
                        </div>
                        ...
                        <div class="list-group list-group-flush mt-2 mb-0 pb-2" id="idMensuelBlock" style="height: 90%">
                            ...
                            <div class="mb-0 bottom-0 card-footer h-25">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Non-Conforme <span class="badge bg-danger rounded-pill">{{ $noConformInStock->count() }}</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="list-group list-group-flush mt-2" id="idHebdomadaireBlock" style="display: none">
                            <div>
                                <ul class="list-group list-group-flush pb-2">
                                    <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center border-top">Total Entré <span class="badge bg-info rounded-pill">{{ $InStockWekly->count() }}</span>
                                    </li>
                                    <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Conforme <span class="badge bg-success rounded-pill">{{ $conformInStockWeekly->count() }}</span>
                                    </li>
                                    <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Non-Conforme <span class="badge bg-danger rounded-pill">{{ $noConformInStockWeekly->count() }}</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="card-body" id="idRotationStockOut" style="display: none">
                        <center><h6 class="my-2 text-decoration-underline">Mensuel</h6></center>
                        ...
                        <hr class="my-4">
                        <center><h6 class="my-2 text-decoration-underline">Hebdomadaire</h6></center>
                        <div class="col d-flex justify-content-center text-center">
                            <div class="p-3">
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3" id="switchBtnImportGroup">
                            <span class="border px-1 rounded cursor-pointer active" id="btnswitchSourcing" onclick="switchDisplaySourcing('blockSourcing')"><i class="bx bxs-circle me-1" style="color: #14abef"></i>Sourcings</span>
                            <span class="border px-1 rounded cursor-pointer" id="btnswitchTransit" onclick="switchDisplayTransit('blockTransit')"><i class="bx bxs-circle me-1" style="color: #ffc107"></i>Ordre de transit</span>
                            <span class="border px-1 rounded cursor-pointer" id="btnswitchtransport" onclick="switchDisplayTransport('blockTransport')"><i class="bx bxs-circle me-1" style="color: #ff7220"></i>Marchndises Importer</span>
                        </div>
                        <div class="content" id="blockSourcing">
                            <div class="row row-cols-1 mt-3 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top border-bottom">
                                <div class="col">
                                    <div class="p-3">
                                        <h5 class="mb-0">{{ round($averageDelaySourcing, 2) }} /jours <i class="bx bx-up-arrow-alt align-middle"></i></h5>
                                ...
                                <div class="col">
                                    <div class="p-3">
                                        ...
                                        <small class="mb-0">Moyenne de produit conforme reçu<span class="text-success"> <i class="bx bx-up-arrow-alt align-middle text-success"></i>{{ $percentageConform }} %</span></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="content" id="blockTransit" style="display: none">
                            <div class="row row-cols-1 mt-3 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top border-bottom">
                                <div class="col">
                                    <div class="p-3">
                                        <h5 class="mb-0">{{ round($averageDelayTransit, 2) }} /jours <i class="bx bx-up-arrow-alt align-middle"></i></h5>
                                ...
                                <div class="col">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <small class="mb-0 text-success text-uppercase">{{ $mostUsedTransitaire->transitaire->raison_sociale ?? 'Inconnu' }}</small> <br>
                                        <small class="mb-0">Nombre de fois<span class="text-success"> <i class="bx bx-up-arrow-alt align-middle text-success"></i>
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    ...
                                                    <div class="badge rounded-pill text-light bg-success p-2 text-uppercase px-3 border-0">
                                                        <i class='bx bxs-circle me-1'></i>Conforme
                                                    </div>
                                                    @endif
                                                    @if ($InPerMonth->conformity == "off")
                                                    <div class="badge rounded-pill text-info bg-light-danger p-2 text-uppercase px-3 border-0">
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="card-body">
                        <div class="button-container row col-12 d-flex justify-content-between mx-1">
                            <button class="rounded-button active col-6 mx-0" id="etatMensuelBtn" onclick="toggleDisplayEtat('blockMensueletat')">Mensuel</button>
                            <button class="rounded-button col-6 mx-0" id="etatHebdoBtn" onclick="toggleDisplayEtatHebdo('blockHebdoetat')">Hebdomadaire</button>
                        </div>
                                ...
                                <div class="card radius-10 overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="progress radius-10 mt-2" style="height: 4.5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $percentageSourcingsPerMonth }}%"></div>
                                        </div>
                                        <div class="mt-1">
                                            <p class="mb-0">Pourcentage : {{ number_format($percentageSourcingsPerMonth, 0) }}%</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card radius-10 overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="progress radius-10 mt-2" style="height:4.5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $percenSourcWaitLivrPerMonth }}%"></div>
                                        </div>
                                        <div class="mt-1">
                                            <p class="mb-0">Represente : {{ number_format($percenSourcWaitLivrPerMonth, 0) }}%</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 py-0">
                                <div class="card radius-10 overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="progress radius-10 mt-2" style="height:4.5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $percenReceivMonth }}%"></div>
                                        </div>
                                        <div class="mt-1">
                            ...
                            <div class="col-12">
                                <div class="card radius-10 overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="progress radius-10 mt-2" style="height: 4.5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $percentageSourcingsPerWekly }}%"></div>
                                        </div>
                                        <div class="mt-1">
                                            <p class="mb-0">Pourcentage : {{ number_format($percentageSourcingsPerWekly, 0) }}%</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card radius-10 overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="progress radius-10 mt-2" style="height: 4.5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $percWaitSourPerWekly }}%"></div>
                                        </div>
                                        <div class="mt-1">
                            ...
                            <div class="col-12">
                                <div class="card radius-10 overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="progress radius-10 mt-2" style="height:4.5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $percentagereceivPerWekly }}%"></div>
                                        </div>
                                        <div class="mt-1">
                                            <p class="mb-0">Represente : {{ number_format($percentagereceivPerWekly, 0) }}%</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-3">
                                        <div class="col">
                                            <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                                <div class="card-body cursor-pointer" data-bs-toggle="modal" data-bs-target="#showAllExportModal">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0 text-secondary font-14 text-uppercase">Total d'expedition</p>
                                        ...
                                        <div class="col">
                                            <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                                <div class="card-body cursor-pointer" data-bs-toggle="modal" data-bs-target="#showActifExportModal">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0 text-secondary font-14 text-uppercase">Total d'expedition Actif</p>
                                        ...
                                        <div class="col">
                                            <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                                <div class="card-body cursor-pointer" data-bs-toggle="modal" data-bs-target="#showStartedDocModal">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0 text-secondary font-14 text-uppercase">Demarrage Document</p>
                                        ...
                                        <div class="col">
                                            <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                                <div class="card-body cursor-pointer" data-bs-toggle="modal" data-bs-target="#inTransitExportModal">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0 text-secondary font-14 text-uppercase">En transit export</p>
                                        ...
                                        <div class="col">
                                            <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                                <div class="card-body cursor-pointer" data-bs-toggle="modal" data-bs-target="#inExpeditionExportModal">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0 text-secondary font-14 text-uppercase">En cours d'expedition</p>
                                        ...
                                        <div class="col">
                                            <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                                                <div class="card-body cursor-pointer" data-bs-toggle="modal" data-bs-target="#deliveredExportModal">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0 text-secondary font-14 text-uppercase">Livré/Expedié</p>
                                ...
                                <div class="col-12 col-lg-8 d-flex">
                                   <div class="card radius-10 w-100">
                                     <div class="card-header">
                                       ...
                                       <div class="card-body">
                                            <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3" id="switchBtnExportGroup">
                                                <span class="border px-2 rounded cursor-pointer active" id="btnGlobalExp" onclick="toggleDisplayBlockExpAll('blockGlobalExp')"><i class="bx bxs-circle me-1" style="color: #14abef"></i>Global</span>
                                                <span class="border px-2 rounded cursor-pointer" id="btnMensuelExp" onclick="toggleDisplayBlockExpMensuel('blockMensuelExp')"><i class="bx bxs-circle me-1" style="color: #ffc107"></i>Mensuel</span>
                                            </div>
                                            <div class="mx-0 px-0" id="blockGlobalExp">
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">Attente de validation des documents<span class="float-end">{{ $percentageExpGlobal }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-ibiza" role="progressbar" style="width: {{ $percentageExpGlobal }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">En Transit<span class="float-end">{{ $percentageExpTransit }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-deepblue" role="progressbar" style="width: {{ $percentageExpTransit }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">En Courd d'Expedition Import<span class="float-end">{{ $percentageExpWaitExp }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-ohhappiness" role="progressbar" style="width: {{ $percentageExpWaitExp }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">Expedié/Livré au client <span class="float-end">{{ $percentageExpDelivered }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-orange" role="progressbar" style="width: {{ $percentageExpDelivered }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mx-0 px-0" id="blockMensuelExp" style="display: none">
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">Attente de validation des documents <sup class="badge rounded-pill bg-gradient-ibiza">{{ $allExpWaitValidatePerMonth->count() }}</sup> <span class="float-end">{{ $percentageExpWaitDocMensuel }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-ibiza" role="progressbar" style="width: {{ $percentageExpWaitDocMensuel }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">En Transit<sup class="badge rounded-pill bg-gradient-deepblue">{{ $countExpDemarrerPerMonth }}</sup><span class="float-end">{{ $percentageExpDemarrerMensuel }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-deepblue" role="progressbar" style="width: {{ $percentageExpDemarrerMensuel }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">En Courd d'Expedition <sup class="badge rounded-pill bg-gradient-ohhappiness">{{ $countExpWaitingPerMonth }}</sup><span class="float-end">{{ $percentageExpWaitingMensuel }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-ohhappiness" role="progressbar" style="width: {{ $percentageExpWaitingMensuel }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="mb-2">Expedié/Livré au client <sup class="badge rounded-pill bg-gradient-orange">{{ $countExpReadyPerMonth }}</sup> <span class="float-end">{{ $percentageExpReadyMensuel }}%</span></p>
                                                            <div class="progress" style="height: 5px;">
                                                                <div class="progress-bar bg-gradient-orange" role="progressbar" style="width: {{ $percentageExpReadyMensuel }}%"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-12 col-lg-4 d-flex">
                                    <div class="card radius-10 w-100">
                                     <div class="card-header">
                                        ...
                                        <ul class="list-group list-group-flush">
                                         <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center border-top">En Attente de validation Documentaire<span class="badge bg-gradient-ibiza rounded-pill">{{ $nbrExpeditionToDocValidate->count() }}</span>
                                         </li>
                                         <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">En Transit <span class="badge bg-gradient-deepblue rounded-pill">{{ $nbrExpeditionStarted->count() }}</span>
                                         </li>
                                         <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">En Livraison <span class="badge bg-gradient-deepblue rounded-pill">{{ $nbrExpeditionLivraison->count() }}</span>
                                         </li>
                                         <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">En cours d'Expedition <span class="badge bg-gradient-ohhappiness rounded-pill">{{ $nbrExpeditionWaitExpedite->count() }}</span>
                                         </li>
                                         <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Livré/Expedié <span class="badge bg-gradient-orange text-white rounded-pill">{{ $nbrExpeditionExpedier->count() }}</span>
                                         </li>
                                     </ul>
                                    </div>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($item->statut == 'startedDoc')
                                            <span class="badge bg-primary text-primary-light px-3 py-1">Demarrage Documentaire</span>
                                        @endif
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
                            <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #14abef"></i>Ordre d'expédition</span>
                            <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ffc107"></i>Ordre de transite</span>
                            <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ff7220"></i>Ordre de transport</span>
                        </div>
                        <div class="row row-cols-1 mt-3 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top border-bottom">
                            <div class="col">
                                <div class="p-3">
                ...
                <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-danger">{{ number_format($total_bon_payer, 0, ',', ' ') }} Fcfa</h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-success">{{ number_format($total_payed, 0, ',', ' ') }} Fcfa</h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-warning">{{ number_format($total_cancel, 0, ',', ' ') }} Fcfa </h4>
                                        <p class="mb-0 font-13">{{ $total_cancel_count }} Facture @if ($total_cancel_count > 0)s
                                        @endif</p>
                                    </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <div>
                                    <h6 class="mb-0">Dernières Facture</h6>
                                </div>
                                <div class="dropdown ms-auto">
                                    <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class='bx bx-dots-horizontal-rounded font-22 text-option'></i>
                                    </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($facture->statut == 'payed')
                                                    <div class="badge rounded-pill text-light bg-gradient-quepal p-2 text-uppercase px-3">
                                                        <i class='bx bxs-circle me-1'></i> Payé
                                                    </div>
                                                @endif
                                                @if ($facture->statut == 'cancel')
                                                    <div class="badge rounded-pill text-light bg-gradient-blooker p-2 text-uppercase px-3">
