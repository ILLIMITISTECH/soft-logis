<div class="modal fade" id="showActifExportModal" tabindex="-1" aria-hidden="true" style="min-width: 750px !important">
    <div class="modal-dialog modal-dialog-scrollable" style="min-width: 650px !important">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-capitalize">Liste des expeditions Actif</h5>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
                                    @foreach ( $nbrTotalExpeditionActif as $item )
									<tr>
                                        <td>{{ $item->num_exp }}</td>
