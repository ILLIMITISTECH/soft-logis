<div class="modal fade" id="deliveredExportModal" tabindex="-1" aria-hidden="true" style="min-width: 750px !important">
    <div class="modal-dialog modal-dialog-scrollable" style="min-width: 650px !important">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Liste des Expeditions Livré Au Client</h5>
