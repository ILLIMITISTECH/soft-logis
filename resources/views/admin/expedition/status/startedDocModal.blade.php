<div class="modal fade" id="showStartedDocModal" tabindex="-1" aria-hidden="true" style="min-width: 750px !important">
    <div class="modal-dialog modal-dialog-scrollable" style="min-width: 650px !important">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase">Liste des expedition en attente Documentaire</h5>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
                                    @foreach ( $nbrExpeditionToDocValidate as $item )
									<tr>
                                        <td>{{ $item->num_exp }}</td>
