        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">En Expedition</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
        ...
        <div class="col-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--end row-->
                    <form action="{{ route('admin.enExpedition') }}" method="get" class="my-3" id="blockCategory">
                    ...
                    <form action="{{ route('admin.enExpedition') }}" method="get" class="my-3" id="blockmarque" style="display: none">
                        <div class="input-group">
                    ...
                    <form action="{{ route('admin.enExpedition') }}" method="get" class="my-3" id="blockFamille" style="display: none">
                        <div class="input-group">
                    ...
                    <div class="table-responsive mt-3">
                        <table id="example2" class="table table-hover table-striped table-sm table-bordered">
                            ...
                            <tbody>
                                @foreach ($inEnExpedition as $item)
